...
# print review_list
beer_input = "br4"
print beer_list.index(beer_input)
...
print get_beer_keywords(beer_input, corpus_tfidf, beer_list, textDict)


def get_similar_beers(beer_input, index, ntop=10):
    """
...
print get_similar_beers(beer_input, index)
